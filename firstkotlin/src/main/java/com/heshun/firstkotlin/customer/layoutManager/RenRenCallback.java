...
import static com.heshun.firstkotlin.customer.layoutManager.CardConfig.MAX_SHOW_COUNT;
import static com.heshun.firstkotlin.customer.layoutManager.CardConfig.SCALE_GAP;
import static com.heshun.firstkotlin.customer.layoutManager.CardConfig.TRANS_Y_GAP;
...
public class RenRenCallback extends ItemTouchHelper.SimpleCallback {
    ...
    /**
     *
     * @param dragDirs 可拖拽的方向标志常数
     * @param swipeDirs 可滑动的方向标志常数
     * @param rv
     * @param adapter
     * @param datas
	 */
